...
def setup_models(dbsession):
    ...
    dbsession.add(item2)
    item_crear = models.Item(nombre='Crear nuevo pasaje', url='#!/add-pasaje', es_menu=False, menu=menu2)
    ...
    dbsession.add(item5)
    item_crear = models.Item(nombre='Crear nuevo pasaje', url='#!/add-pasaje', es_menu=False, menu=menu4)
    dbsession.add(item_crear)
